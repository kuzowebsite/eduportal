...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    // Validate special code (mock validation - in real app this would check against valid codes)
    if (!formData.code.trim()) {
      newErrors.code = "Тусгай код оруулна уу"
      isValid = false
    } else if (formData.code !== "BOOK2024") {
      // Example validation code
      newErrors.code = "Тусгай код буруу байна"
      isValid = false
    }
    ...
    if (validateForm()) {
      try {
        ...
        toast({
          ...
          description: "Таны бүртгэл амжилттай үүслээ. Одоо нэвтэрч болно.",
        })
      ...
      <div className="container mx-auto px-4 py-10">
        <Card className="max-w-md mx-auto">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Номын тусгай кодыг ашиглан бүртгүүлнэ үү</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="code">Тусгай код</Label>
                <Input
                  id="code"
                  name="code"
                  placeholder="Номын тусгай кодыг оруулна уу"
                  value={formData.code}
